...
// For previous version, see http://androidxref.com/1.6/s?defs=ServiceCommand&project=frameworks
/**
 * @hide This should not be made public in its present form because it
 * assumes that private and secret key bytes are available and would
 * preclude the use of hardware crypto.
 */
public class HiddenKeyStore {
    ...
    private HiddenKeyStore() {
    }

    public static HiddenKeyStore getInstance() {
        return new HiddenKeyStore();
    }
